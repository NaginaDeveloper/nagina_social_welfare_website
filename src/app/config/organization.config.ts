...
export const ORGANIZATION = {
  ...
  /** UK supermarket shelf Halal/Haram quiz (admin portal, no login). */
  supermarketQuizUrl:
    'https://admin.naginasocialwelfare.co.uk/quiz/setup/halal-haram-uk-supermarket',
  ...
  tiktokUrl: 'https://www.tiktok.com/@nagina.social.wel',
  tiktokEmbedUrl: 'https://www.tiktok.com/embed/@nagina.social.wel',
