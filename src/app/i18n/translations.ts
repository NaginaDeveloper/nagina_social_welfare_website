...
export const TRANSLATIONS: Record<UiLang, Record<string, string>> = {
  en: {
    ...
    'hub.searchPlaceholder': 'Search prayer times, Quran, donate, quiz…',
    ...
    'donate.zakatLead':
      'Indicative 2.5% on wealth above the minimum threshold for Zakat (nisab). Confirm with a scholar for your situation. Nisab figures are a guide and should be checked against current gold and silver prices.',
    ...
    'donate.nisabNote': 'Using the silver nisab (minimum threshold) as a cautious Hanafi guide.',
  ...
  ur: {
    ...
    'hub.searchPlaceholder': 'نماز، قرآن، عطیہ، کوئز تلاش کریں…',
