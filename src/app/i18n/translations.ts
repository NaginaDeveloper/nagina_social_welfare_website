...
export const TRANSLATIONS: Record<UiLang, Record<string, string>> = {
  en: {
    ...
    'madrasa.body2': 'Whether you need evening madrasa sessions, weekend Islamic school, or ongoing Quran classes for children in Peterborough, please contact us to ask about current classes and enrolment.',
  ...
  ur: {
    ...
    'about.lead':
      'ناگینا سوشل ویلفیئر برطانیہ بھر کی کمیونٹیز کی خدمت علم اور ہمدردی سے کرتی ہے۔ ہم یقین رکھتے ہیں کہ سچی تعلیم اور خلوصِ خیرات زندگیاں بدل دیتی ہے — نہ صرف ذہن، بلکہ اخلاق، ایمان اور تعلق بھی سنوارتی ہے۔ ہمارے دونوں بازو، مرکز دینِ اسلام اور ناگینا سوشل ویلفیئر، اسی مشن کو آگے بڑھاتے ہیں۔',
    ...
    'guide.lead':
      'ایک محبوب عالم اور صوفی رہنما جن کی تعلیمِ شیریں گفتاری، صبر، علم اور خیرات آج بھی ناگینا سوشل ویلفیئر اور مرکز دینِ اسلام کے کام کو روشن کر رہی ہے۔ اللہ تعالیٰ ان کا درجہ بلند فرمائے۔ آمین۔',
    ...
    'photos.lead':
      'ناگینا ٹی وی سے منتخب تصاویر، جو آپ کے بیانات اور محافل کا سرکاری ریکارڈ ہے۔ اللہ تعالیٰ ان کا درجہ بلند فرمائے۔ آمین۔',
    'photos.credit': 'تصاویر بشکریہ',
    'photos.creditEnd': ' اور ناگینا آرکائیو۔',
    ...
    'work.lead': 'ناگینا سوشل ویلفیئر یو کے ایمان اور ہمدردی کو جوڑتی ہے — علم سے دلوں کی تعلیم اور خیرات سے زندگیوں کی پرورش۔',
    ...
    'sermons.lead': 'سیدھا راستہ مجموعے کے مبارک بیانات — عنوان سے تلاش کریں اور یوٹیوب (ناگینا ٹی وی) پر دیکھیں۔',
    ...
    'safeguarding.lead': 'ناگینا سوشل ویلفیئر اور مرکز دینِ اسلام بچوں اور خطرے میں بالغوں کی حفاظت کیسے کرتے ہیں۔',
    ...
    'privacy.lead': 'اس ویب سائٹ کے استعمال پر ناگینا سوشل ویلفیئر معلومات کیسے سنبھالتی ہے۔',
    ...
    'assistant.eyebrow': 'ناگینا اسسٹنٹ',
    ...
    'assistant.welcome': 'السلام علیکم۔ میں حنفی بریلوی / اہلِ سنت عقیدہ اور ہدایت میں نرمی سے مدد کر سکتا ہوں — پہلے ہماری شائع شدہ ناگینا صفحات سے، اور ضرورت پر اسی مسلک کے مطابق وسیع تر جیمنائی اسلامی علم سے — نیز عطیات، رابطہ اور نماز کے اوقات جیسے ویب سائٹ سوالات، انگریزی یا اردو میں۔',
    'assistant.disclaimer': 'میں مفتی نہیں ہوں۔ ذاتی شرعی احکام کے لیے براہِ کرم مرکز سے براہِ راست رابطہ کریں۔',
    'assistant.pageTitle': 'ناگینا اسسٹنٹ',
    ...
    'madrasa.body2': 'شام کی نشستیں، اختتامِ ہفتہ اسلامی اسکول، یا پیٹربورو میں بچوں کی جاری قرآن کلاسیں چاہیں تو موجودہ کلاسز اور داخلے کے لیے ہم سے رابطہ کریں۔',
