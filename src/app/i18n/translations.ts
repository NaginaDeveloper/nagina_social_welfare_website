...
export const TRANSLATIONS: Record<UiLang, Record<string, string>> = {
  en: {
    ...
    'spotlight.halalCheckerCta': 'Shop helper',
    'spotlight.halalCheckerTitle': 'Halal barcode helper',
    'spotlight.halalCheckerLead':
      'Look up a UK pack barcode for reported Halal labels — helper only, not a certificate.',
    ...
    'nav.quizHint': 'Halal/Haram & knowledge — timed',
    'nav.halalChecker': 'Halal barcode helper',
    'nav.halalCheckerHint': 'Pack label lookup — not a certificate',
  ...
  ur: {
    ...
    'spotlight.halalCheckerCta': 'خریداری مدد',
    'spotlight.halalCheckerTitle': 'حلال بارکوڈ مددگار',
    'spotlight.halalCheckerLead':
      'برطانیہ کی پیکج بارکوڈ سے رپورٹ شدہ حلال لیبل دیکھیں — صرف مددگار، سرٹیفکیٹ نہیں۔',
