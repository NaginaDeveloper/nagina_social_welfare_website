...
export const TRANSLATIONS: Record<UiLang, Record<string, string>> = {
  en: {
    ...
    'header.myMembershipShort': 'Account',
    ...
    'spotlight.namazNext': 'Next Salah',
    'spotlight.namazCta': 'Prayer times',
    ...
    'spotlight.donateLead':
      'Zakat, Sadaqah (voluntary charity) and general gifts for education and welfare.',
    ...
    'spotlight.quizLead':
      'Beat the clock — Halal or Haram, UK supermarket shelf products, and knowledge quizzes for the whole family.',
    ...
    'spotlight.halalCheckerLead':
      'Scan a UK shop barcode for pack labels, then try our supermarket products quiz — what to look for on the shelf. Helper only, not a certificate.',
    'spotlight.halalCheckerOpen': 'Check a barcode',
    'spotlight.halalCheckerAria': 'Open Halal barcode helper (opens in a new tab)',
    ...
    'hub.group.about': 'About',
    'hub.group.beliefs': 'Beliefs',
    'hub.group.worship': 'Worship',
    'hub.group.learn': 'Learn',
    ...
    'donate.zakatLead':
      'Work out zakat on jewellery by weight, nisab, and 2.5% — then give it here as Zakat.',
    'donate.openZakatCalc': 'Open the zakat calculator',
    ...
    'donate.belowNisab': 'Below the nisab threshold — zakat not due on this estimate.',
    'donate.nisabNote': 'Using the silver nisab (minimum threshold) as a cautious guide.',
    'donate.applyAmount': 'Use this amount',
    'donate.reference': 'Please use this as your payment reference so we can thank you.',

    'zakat.eyebrow': 'Pillar of Islam',
    'zakat.title': 'Zakat Calculator',
    'zakat.lead':
      'A simple estimate for UK households. Gold and silver jewellery is included even if worn. Confirm unusual cases with a scholar.',
    'zakat.goldNisab': 'Gold nisab',
    'zakat.silverNisab': 'Silver nisab',
    'zakat.spotPrices': 'Spot prices',
    'zakat.goldPrice': 'Gold',
    'zakat.silverPrice': 'Silver',
    'zakat.pricesLoading': 'Updating live gold and silver prices…',
    'zakat.pricesLive': 'Live UK spot',
    'zakat.pricesFallback': 'Guide prices — live market unavailable just now.',
    'zakat.tola': 'tola',
    'zakat.hawl': 'I have held nisab for one lunar year (hawl)',
    'zakat.hawlHint':
      'Zakat is due after a lunar year of possessing the nisab. Untick this if the year is not yet complete.',
    'zakat.cash': 'Cash and savings',
    'zakat.cashHint': 'Cash in hand, current and savings accounts, and money in wallets you can spend.',
    'zakat.amountGbp': 'Amount (£)',
    'zakat.gold': 'Gold — including jewellery',
    'zakat.goldHint':
      'Gold jewellery is included even if worn. Enter weight and karat; we convert to fine gold. 1 tola = 11.664 g.',
    'zakat.silver': 'Silver — including jewellery',
    'zakat.silverHint': 'Silver jewellery is also included. Sterling is counted at 92.5% silver.',
    'zakat.weight': 'Weight',
    'zakat.unit': 'Unit',
    'zakat.unitGrams': 'grams',
    'zakat.unitTola': 'tola',
    'zakat.karat': 'Karat',
    'zakat.purity': 'Purity',
    'zakat.silverFine': 'Fine (999)',
    'zakat.silverSterling': 'Sterling (925)',
    'zakat.addGold': '+ Add gold item',
    'zakat.addSilver': '+ Add silver item',
    'zakat.remove': 'Remove',
    'zakat.business': 'Business stock (£)',
    'zakat.businessHint': 'Trade goods and stock you hold to sell, at today’s market value.',
    'zakat.investments': 'Investments and crypto (£)',
    'zakat.investmentsHint': 'Shares, funds or crypto held as wealth. Use today’s market value.',
    'zakat.receivables': 'Money owed to you (£)',
    'zakat.receivablesHint': 'Loans and invoices you expect to receive.',
    'zakat.debts': 'Debts due now (£)',
    'zakat.debtsHint':
      'Deduct what is payable now — overdue bills and this year’s instalments. Do not deduct the full remaining mortgage.',
    'zakat.due': 'Zakat due',
    'zakat.rateLine': '{n}% of net zakatable wealth',
    'zakat.belowNisab': 'Below nisab on this estimate — zakat is not due.',
    'zakat.hawlPending': 'Nisab is reached. If the lunar year is complete, about {amount} would be due.',
    'zakat.usingGoldNisab': 'Gold-only wealth — gold nisab applied.',
    'zakat.usingSilverNisab': 'Cash or mixed wealth — silver nisab applied.',
    'zakat.assets': 'Zakatable assets',
    'zakat.liabilities': 'Debts deducted',
    'zakat.net': 'Net wealth',
    'zakat.goldValue': 'Gold value',
    'zakat.silverValue': 'Silver value',
    'zakat.give': 'Give this zakat',
    'zakat.reset': 'Clear figures',
    'zakat.payNote': 'Opens Donate with the Zakat fund and this amount.',
    'zakat.rulesTitle': 'How this calculator works',
    'zakat.rule1': 'Rate is 2.5% (one-fortieth) on net zakatable wealth.',
    'zakat.rule2': 'Gold nisab is 7.5 tola (87.48 g). Silver nisab is 52.5 tola (612.36 g).',
    'zakat.rule3': 'If you have only gold, gold nisab is used. Cash, silver, stock or mixed wealth uses silver nisab.',
    'zakat.rule4': 'Gold and silver jewellery is included, even if worn.',
    'zakat.rule5': 'A lunar year (hawl) of owning nisab is required before zakat becomes due.',
    'zakat.excludeTitle': 'What not to include',
    'zakat.exclude1': 'The home you live in, your personal car, furniture and clothes.',
    'zakat.exclude2': 'Diamonds, pearls and other stones that are not gold or silver, kept for personal use.',
    'zakat.exclude3': 'Tools and equipment of a business that you are not selling.',
    'zakat.exclude4': 'The full remaining mortgage — only instalments and debts due now.',
    'zakat.fitranaNote':
      'Sadaqat al-Fitr (Fitrana) is separate from this wealth zakat. Give Fitrana before Eid prayer on the Donate page.',
    'zakat.disclaimer':
      'This is an estimate, not a personal fatwa. Livestock, crops and complex businesses need a scholar. Spot prices move; jewellery shop rates may differ. Nagina Social Welfare UK (charity 1196514) can receive your zakat for eligible need.',
    ...
    'apply.intake.teachingsHint': 'Prayer, manners and belief.',
    'apply.intake.hadith': 'Hadith studies',
    'apply.intake.hadithHint': 'Sayings of Prophet Muhammad ﷺ.',
    'apply.intake.academics': 'Islamic academics',
    'apply.intake.academicsHint': 'Arabic, supplications (duas) and structured Islamic study.',
    ...
    'nav.staffPortalHint': 'Admin, teachers and parents',
    ...
    'membership.age': 'Age',
    'membership.ageHint': 'Enter your age in whole years (must be 18 or over).',
    ...
    'membership.signInPrompt': 'Already a member?',
    'membership.signInLink': 'Sign in',
    ...
    'membership.err.age': 'Enter your age in whole years (18 or over).',
    ...
    'memberHome.quiz': 'Islamic Quiz',
    'memberHome.quizAria': 'Play Islamic Quiz (opens in a new tab)',
    'memberHome.halalChecker': 'Halal barcode',
    'memberHome.halalCheckerAria': 'Open Halal barcode helper (opens in a new tab)',
    ...
    'nav.khatmeNabuwwatHint': 'Seal of the Prophets ﷺ',
    'nav.ahleBait': 'Ahl al-Bayt',
    'nav.ahleBaitHint': 'The Prophet’s family',
    'nav.sahabaIkram': 'Companions of the Prophet ﷺ',
    'nav.sahabaIkramHint': 'The noble Sahaba',
    'nav.auliaKaram': 'Awliya Allah',
    'nav.auliaKaramHint': 'Friends of Allah',
    'nav.basicBeliefs': 'Basic Beliefs',
    'nav.basicBeliefsHint': 'Hanafi Barelvi creed FAQ',
    ...
    'nav.books': 'Books',
    'nav.booksHint': 'Seedha Rastah library',
    'nav.quiz': 'Islamic Quiz',
    'nav.quizHint': 'Halal/Haram, supermarket shelf & knowledge',
    'nav.halalChecker': 'Halal barcode helper',
    'nav.halalCheckerHint': 'Pack labels + supermarket quiz',
    'nav.seedhaRastah': 'Seedha Rastah',
    'nav.seedhaRastahHint': 'Original archive',
    'nav.sermons': 'Sermons',
    'nav.sermonsHint': 'Sermons by Baba Ji Sarkar',
    ...
    'hero.lead':
      'A UK-based charity (1196514) uniting faith and compassion — nurturing minds through Islamic education and uplifting lives through community welfare.',
    ...
    'about.videoTitle': 'About Nagina Social Welfare',
    'about.videoCaption': 'Watch a short introduction to our work.',
    'about.videoOpen': 'Open full video',
    ...
    'guide.shajra': 'Spiritual lineage (Shajra Sharif)',
    ...
    'seedha.statSermons': 'Sermons hosted here',
    'seedha.statTv': 'Nagina TV on YouTube',
    'seedha.collectionsEyebrow': 'Explore the collection',
    'seedha.collectionsTitle': 'Books, Sermons, and the',
    ...
    'seedha.cardSermons': 'Video sermons',
    ...
    'seedha.dir.audio': 'Audio sermons',
    'seedha.dir.audioHint': 'Recorded lectures',
    'seedha.dir.video': 'Audio & video',
    'seedha.dir.videoHint': 'Video sermon archive',
    ...
    'seedha.dir.tabia': 'Character (Tabi‘ah)',
    ...
    'shajra.lead':
      'The blessed Yusufi lineages — Naqshbandi Mujaddidi in a longer and a shorter recitation, then Chishti Sabri Siraji Sardari, then Qadri Razawi — each read for the sake of the Prophet ﷺ, the Ahl al-Bayt, the Companions and the spiritual teachers (mashayikh), and ending in honour of the spiritual guide of the path (Pir-e-Tariqat), guide of sacred law (Rehbar-e-Shariat) Haji Muhammad Yusuf Ali Nagina',
    'shajra.source': 'From this book',
    'shajra.sourceCredit':
      'The lineage pages below are shown from this book, Kashkool e Yousufi.',
    ...
    'shajra.index': 'The lineages',
    'shajra.order.naqshbandi': 'Naqshbandi Mujaddidi Yusufi',
    'shajra.respectedName': 'Respected name',
    'shajra.respectedNames': 'Respected names',
    'shajra.openPage': 'Open lineage page',
    'shajra.close': 'Close',
    ...
    'guidance.lead':
      'Reflect on timeless teachings that guide our preachers, students and supporters — from character to knowledge and Sadaqah (voluntary charity).',
    'guidance.teachingsOf': 'Teachings of',
    'guidance.viewFull': 'View full size',
    'guidance.close': 'Close full-size poster',

    'khatme.eyebrow': 'Seal of the Prophets (Khatam-un-Nabiyyin)',
    'khatme.title': 'The Unshakable Foundation of Islam:',
    'khatme.titleAccent': 'The Finality of Prophethood',
    'khatme.lead':
      'Belief in the absolute finality of the Prophethood of Muhammad ﷺ is not merely a doctrine; it is the cornerstone of Islamic faith, the seal of divine guidance, and the eternal bond unifying the global Muslim community (Ummah).',
    'khatme.caption': 'Finality of Prophethood — the Seal of the Prophets ﷺ',
    'khatme.body1':
      'Allah Almighty declared the completion of His message to humanity through the Last of the Prophets. Through Prophet Muhammad ﷺ, divine revelation reached its pinnacle. The religion was perfected, the Quran preserved for all time, and the path to righteousness forever illuminated.',
    'khatme.body2':
      'The Messenger of Allah ﷺ affirmed this fundamental truth in explicit terms — completing the house of prophethood as its final brick, and leaving no prophet after him.',
    'khatme.whyEyebrow': 'Why it matters',
    'khatme.whyTitle': 'Why the Finality of Prophethood Matters to',
    'khatme.whyAccent': 'every Muslim',
    'khatme.closing':
      'Let us stand firm upon this essential creed, honouring the legacy of the Beloved Messenger ﷺ, and conveying his message of mercy with clarity and love.',

    'ahle.eyebrow': 'Ahl al-Bayt — the Blessed Household',
    ...
    'sahaba.titleAccent': 'Companions (Sahabah)',
    'sahaba.lead':
      'According to the consensus of Sunni Islam (Ahl al-Sunnah wal-Jama’ah), all Companions (Sahabah) of the Messenger of Allah ﷺ (peace be upon him) are considered upright (‘adil), sincere, and the noble generation of the Muslim community (Ummah). Loving and respecting them is regarded as an integral part of Islamic faith.',
    'sahaba.caption': 'Love for the Companions of the Prophet ﷺ is part of faith',

    'aulia.eyebrow': 'Friends of Allah',
    'aulia.title': 'Belief Regarding the',
    'aulia.titleAccent': 'Awliya Allah',
    'aulia.lead':
      'According to the consensus of Ahl al-Sunnah wal-Jama’ah, the Awliya Allah are the righteous friends of Allah — honoured through faith, God-consciousness (taqwa), and sincere obedience. Loving and respecting them is part of authentic Sunni spirituality, always within the bounds of the Quran and Sunnah.',
    'aulia.caption': 'The Awliya Allah — no fear upon them, nor shall they grieve',

    'beliefs.eyebrow': 'Creed (Aqidah)',
    ...
    'namaz.awaiting': 'Awaiting next Salah',
    'namaz.next': 'Next',
    'namaz.tomorrow': 'tomorrow',
    'namaz.todayTitle': 'Today’s Salah',
    'namaz.begins': 'Begins',
    'namaz.ends': 'Ends',
    ...
    'quran.lead':
      'Recite and reflect upon the Holy Quran with the blessed translation of Imam Ahmad Raza Khan (Ala Hazrat) — Kanzul Iman.',
    ...
    'sermons.lead':
      'Watch latest clips from Nagina TV and Nagina Social Welfare, or search the Seedha Rastah sermon archive.',
    'sermons.search': 'Search Nagina TV, YouTube & sermons…',
    'sermons.searchLabel': 'Search videos and sermons',
    'sermons.searchHint':
      'Searches Nagina TV, the Nagina Social Welfare YouTube channel, and the Seedha Rastah archive.',
    'sermons.loading': 'Loading sermons…',
    'sermons.empty': 'No videos match your search.',
    'sermons.one': 'sermon',
    'sermons.many': 'sermons',
    'sermons.resultOne': 'result',
    'sermons.resultMany': 'results',
    ...
    'sermons.tiktokLead':
      'Latest short clips from @nagina.social.wel — updated automatically.',
    'sermons.tiktokCta': 'Watch on TikTok',
    'sermons.tiktokMore': 'See all clips on TikTok',
    'sermons.youtubeEyebrow': 'YouTube',
    'sermons.youtubeTitle': 'Latest on YouTube',
    'sermons.youtubeLead':
      'Newest uploads from the Nagina Social Welfare YouTube channel — updated automatically.',
    'sermons.youtubeChannelCta': 'Nagina Social Welfare',
    'sermons.naginaTvEyebrow': 'Nagina TV',
    'sermons.naginaTvTitle': 'Latest from Nagina TV',
    'sermons.naginaTvLead':
      'Newest uploads from Nagina TV (the Seedha Rastah sermons channel) — updated automatically.',
    'sermons.latestLoading': 'Loading latest videos…',
    'sermons.archiveHint':
      'Looking for an older bayan? Use the search above — it includes the full Seedha Rastah sermon archive.',
    'sermons.sourceNaginaTv': 'Nagina TV',
    'sermons.sourceOrgYoutube': 'Nagina Social Welfare',
    'sermons.sourceArchive': 'Seedha Rastah archive',
    ...
    'assistant.welcome':
      'Assalamu alaikum (peace be upon you). I can gently help with Hanafi Barelvi / Ahl al-Sunnah creed and guidance — first from our published Nagina pages, and when needed from broader Gemini Islamic knowledge within the same school of thought — plus website questions such as donations, contact, and prayer (Salah) times, in English or Urdu.',
    'assistant.disclaimer':
      'I am not a mufti (a scholar who issues personal rulings). For personal religious rulings, please contact Markaz directly.',
    'assistant.call': 'Call',
    ...
    'assistant.pageLead':
      'Ask about creed, guidance, donations, contact, and prayer (Salah) times — in English or Urdu.',
  ...
  ur: {
    ...
    'header.myMembershipShort': 'اکاؤنٹ',
    ...
    'spotlight.halalCheckerCta': 'مفت ٹول',
    'spotlight.halalCheckerTitle': 'حلال بارکوڈ مددگار',
    'spotlight.halalCheckerLead':
      'برطانیہ کی پیکج بارکوڈ اسکین یا ٹائپ کریں — رپورٹ شدہ حلال لیبل؛ صرف مددگار، سرٹیفکیٹ نہیں۔',
    'spotlight.halalCheckerOpen': 'بارکوڈ چیک کریں',
    'spotlight.halalCheckerAria': 'حلال بارکوڈ مددگار کھولیں (نئی ٹیب میں کھلے گی)',
    ...
    'hub.group.about': 'تعارف',
    'hub.group.beliefs': 'عقائد',
    'hub.group.worship': 'عبادت',
    'hub.group.learn': 'تعلیم',
    ...
    'donate.zakatLead':
      'زیورات وزن سے، نصاب، اور ۲.۵٪ کے ساتھ زکوٰۃ نکالیں — پھر یہاں زکوٰۃ کے طور پر ادا کریں۔',
    'donate.openZakatCalc': 'زکوٰۃ کیلکولیٹر کھولیں',
    ...
    'donate.nisabNote': 'احتیاط کے طور پر چاندی کا نصاب استعمال ہو رہا ہے۔',
    'donate.applyAmount': 'یہ رقم استعمال کریں',
    'donate.reference': 'براہِ کرم یہ حوالہ استعمال کریں تاکہ ہم آپ کا شکریہ ادا کر سکیں۔',

    'zakat.eyebrow': 'رکنِ اسلام',
    'zakat.title': 'زکوٰۃ کیلکولیٹر',
    'zakat.lead':
      'برطانیہ کے گھرانوں کے لیے سادہ تخمینہ۔ سونے اور چاندی کے زیورات پہنے ہوئے بھی شامل ہیں۔ غیر معمولی صورت میں عالم سے تصدیق کریں۔',
    'zakat.goldNisab': 'سونے کا نصاب',
    'zakat.silverNisab': 'چاندی کا نصاب',
    'zakat.spotPrices': 'بازار کی قیمت',
    'zakat.goldPrice': 'سونا',
    'zakat.silverPrice': 'چاندی',
    'zakat.pricesLoading': 'سونے اور چاندی کی تازہ قیمتیں آ رہی ہیں…',
    'zakat.pricesLive': 'برطانوی لائیو قیمت',
    'zakat.pricesFallback': 'رہنما قیمتیں — لائیو بازار اب دستیاب نہیں۔',
    'zakat.tola': 'تولہ',
    'zakat.hawl': 'میں نے ایک قمری سال (حول) تک نصاب رکھا ہے',
    'zakat.hawlHint':
      'نصاب رکھنے کے بعد ایک قمری سال گزرنے پر زکوٰۃ واجب ہوتی ہے۔ اگر سال پورا نہیں ہوا تو نشان ہٹا دیں۔',
    'zakat.cash': 'نقد اور بچت',
    'zakat.cashHint': 'ہاتھ میں نقد، کرنٹ اور سیونگ اکاؤنٹ، اور وہ بٹوے جن سے آپ خرچ کر سکتے ہیں۔',
    'zakat.amountGbp': 'رقم (£)',
    'zakat.gold': 'سونا — زیورات سمیت',
    'zakat.goldHint':
      'سونے کے زیورات پہنے ہوئے بھی شامل ہیں۔ وزن اور کیرٹ درج کریں؛ خالص سونا نکالا جاتا ہے۔ ۱ تولہ = ۱۱.۶۶۴ گرام۔',
    'zakat.silver': 'چاندی — زیورات سمیت',
    'zakat.silverHint': 'چاندی کے زیورات بھی شامل ہیں۔ اسٹرلنگ چاندی ۹۲.۵٪ شمار ہوتی ہے۔',
    'zakat.weight': 'وزن',
    'zakat.unit': 'اکائی',
    'zakat.unitGrams': 'گرام',
    'zakat.unitTola': 'تولہ',
    'zakat.karat': 'کیرٹ',
    'zakat.purity': 'خالصیت',
    'zakat.silverFine': 'خالص (۹۹۹)',
    'zakat.silverSterling': 'اسٹرلنگ (۹۲۵)',
    'zakat.addGold': '+ سونا شامل کریں',
    'zakat.addSilver': '+ چاندی شامل کریں',
    'zakat.remove': 'ہٹائیں',
    'zakat.business': 'کاروباری مال (£)',
    'zakat.businessHint': 'بیچنے کے لیے رکھا ہوا مالِ تجارت، آج کی بازاری قیمت پر۔',
    'zakat.investments': 'سرمایہ کاری اور کرپٹو (£)',
    'zakat.investmentsHint': 'حصص، فنڈز یا کرپٹو جو دولت کے طور پر ہوں۔ آج کی قیمت لگائیں۔',
    'zakat.receivables': 'آپ کے ذمے واجب رقم (£)',
    'zakat.receivablesHint': 'قرضے اور بل جو آپ وصول کرنے کے امیدوار ہیں۔',
    'zakat.debts': 'ابھی واجب قرض (£)',
    'zakat.debtsHint':
      'ابھی ادا ہونے والی رقم کاٹیں — باقی قسطیں اور اس سال کی اقساط۔ پورا رہن نہ کاٹیں۔',
    'zakat.due': 'واجب زکوٰۃ',
    'zakat.rateLine': 'خالص زکوٰۃ کی دولت کا {n}٪',
    'zakat.belowNisab': 'اس تخمینے پر نصاب سے کم — زکوٰۃ واجب نہیں۔',
    'zakat.hawlPending': 'نصاب پورا ہے۔ اگر قمری سال مکمل ہو تو تقریباً {amount} واجب ہوگی۔',
    'zakat.usingGoldNisab': 'صرف سونا — سونے کا نصاب لگایا گیا۔',
    'zakat.usingSilverNisab': 'نقد یا مخلوط دولت — چاندی کا نصاب لگایا گیا۔',
    'zakat.assets': 'زکوٰۃ کی چیزیں',
    'zakat.liabilities': 'کٹوتی قرض',
    'zakat.net': 'خالص دولت',
    'zakat.goldValue': 'سونے کی قیمت',
    'zakat.silverValue': 'چاندی کی قیمت',
    'zakat.give': 'یہ زکوٰۃ ادا کریں',
    'zakat.reset': 'اندراجات صاف کریں',
    'zakat.payNote': 'عطیہ صفحہ زکوٰۃ فنڈ اور اس رقم کے ساتھ کھلے گا۔',
    'zakat.rulesTitle': 'یہ کیلکولیٹر کیسے کام کرتا ہے',
    'zakat.rule1': 'شرح ۲.۵٪ (چالیسواں حصہ) خالص زکوٰۃ کی دولت پر ہے۔',
    'zakat.rule2': 'سونے کا نصاب ۷.۵ تولہ (۸۷.۴۸ گرام)۔ چاندی کا نصاب ۵۲.۵ تولہ (۶۱۲.۳۶ گرام)۔',
    'zakat.rule3': 'اگر صرف سونا ہو تو سونے کا نصاب۔ نقد، چاندی، مالِ تجارت یا مخلوط دولت پر چاندی کا نصاب۔',
    'zakat.rule4': 'سونے اور چاندی کے زیورات پہنے ہوئے بھی شامل ہیں۔',
    'zakat.rule5': 'نصاب رکھنے کے بعد ایک قمری سال (حول) ضروری ہے تب زکوٰۃ واجب ہوتی ہے۔',
    'zakat.excludeTitle': 'کیا شامل نہ کریں',
    'zakat.exclude1': 'رہائشی گھر، ذاتی گاڑی، فرنیچر اور کپڑے۔',
    'zakat.exclude2': 'ہیرے، موتی اور وہ پتھر جو سونا یا چاندی نہ ہوں، ذاتی استعمال کے۔',
    'zakat.exclude3': 'کاروباری اوزار جو آپ بیچ نہیں رہے۔',
    'zakat.exclude4': 'رہن کی پوری باقی رقم نہیں — صرف ابھی واجب اقساط اور قرضے۔',
    'zakat.fitranaNote':
      'صدقۃ الفطر (فطرانہ) اس مال کی زکوٰۃ سے الگ ہے۔ عید کی نماز سے پہلے عطیہ صفحے پر فطرانہ دیں۔',
    'zakat.disclaimer':
      'یہ تخمینہ ہے، ذاتی فتویٰ نہیں۔ مویشی، فصل اور پیچیدہ کاروبار کے لیے عالم سے رجوع کریں۔ بازار کی قیمتیں بدلتی رہتی ہیں۔ نگینہ سوشل ویلفیئر یو کے (چیریٹی 1196514) اہل ضرورت کے لیے آپ کی زکوٰۃ وصول کر سکتا ہے۔',
    ...
    'apply.intake.teachingsHint': 'نماز، اخلاق اور عقیدہ۔',
    'apply.intake.hadith': 'حدیث کی تعلیم',
    'apply.intake.hadithHint': 'اقوالِ رسول محمد ﷺ۔',
    'apply.intake.academics': 'اسلامی علوم',
    ...
    'nav.staffPortalHint': 'ایڈمن، اساتذہ اور والدین',
    'nav.membershipTrack': 'درخواست کا ٹریک',
    'nav.membershipTrackHint': 'درخواست کی صورتحال دیکھیں',
    'membership.signInPrompt': 'پہلے سے ممبر ہیں؟',
    'membership.signInLink': 'سائن ان',
    'membership.age': 'عمر',
    'membership.ageHint': 'اپنی عمر سالوں میں لکھیں (۱۸ سال یا اس سے زیادہ)۔',
    'membership.err.age': 'عمر سالوں میں لکھیں (۱۸ یا اس سے زیادہ)۔',
    ...
    'memberHome.quiz': 'اسلامی کوئز',
    'memberHome.quizAria': 'اسلامی کوئز کھیلیں (نئی ٹیب میں کھلے گی)',
    'memberHome.halalChecker': 'حلال بارکوڈ',
    'memberHome.halalCheckerAria': 'حلال بارکوڈ مددگار کھولیں (نئی ٹیب میں کھلے گی)',
    ...
    'nav.quiz': 'اسلامی کوئز',
    'nav.quizHint': 'حلال/حرام اور علم — وقتی',
    'nav.halalChecker': 'حلال بارکوڈ مددگار',
    'nav.halalCheckerHint': 'پیکج لیبل تلاش — سرٹیفکیٹ نہیں',
    ...
    'hero.lead':
      'برطانیہ کی ایک رجسٹرڈ چیریٹی (1196514) جو ایمان اور ہمدردی کو جوڑتی ہے — اسلامی تعلیم سے ذہنوں کو سنوارتی ہے اور فلاحِ عامہ سے زندگیوں کو سنبھالتی ہے۔',
    ...
    'about.videoTitle': 'نگینہ سوشل ویلفیئر کے بارے میں',
    'about.videoCaption': 'ہمارے کام کا مختصر تعارف دیکھیں۔',
    'about.videoOpen': 'مکمل ویڈیو کھولیں',
    ...
    'shajra.index': 'سلسلے',
    'shajra.order.naqshbandi': 'نقشبندیہ مجددیہ یوسفیہ',
    ...
    'sermons.lead':
      'نگینہ ٹی وی اور نگینہ سوشل ویلفیئر کی تازہ کلپس دیکھیں، یا سیدھا راستہ بیانات کے آرکائیو میں تلاش کریں۔',
    'sermons.search': 'نگینہ ٹی وی، یوٹیوب اور بیانات تلاش…',
    'sermons.searchLabel': 'ویڈیوز اور بیانات تلاش کریں',
    'sermons.searchHint':
      'نگینہ ٹی وی، نگینہ سوشل ویلفیئر یوٹیوب چینل، اور سیدھا راستہ آرکائیو میں تلاش کرتا ہے۔',
    'sermons.loading': 'بیانات لوڈ ہو رہے ہیں…',
    'sermons.empty': 'آپ کی تلاش سے کوئی ویڈیو نہیں ملی۔',
    'sermons.one': 'بیان',
    'sermons.many': 'بیانات',
    'sermons.resultOne': 'نتیجہ',
    'sermons.resultMany': 'نتائج',
    ...
    'sermons.tiktokLead':
      '@nagina.social.wel کی تازہ مختصر کلپس — خود بخود اپ ڈیٹ ہوتی ہیں۔',
    'sermons.tiktokCta': 'ٹک ٹاک پر دیکھیں',
    'sermons.tiktokMore': 'ٹک ٹاک پر تمام کلپس دیکھیں',
    'sermons.youtubeEyebrow': 'یوٹیوب',
    'sermons.youtubeTitle': 'یوٹیوب پر تازہ ترین',
    'sermons.youtubeLead':
      'نگینہ سوشل ویلفیئر یوٹیوب چینل کی تازہ ویڈیوز — خود بخود اپ ڈیٹ ہوتی ہیں۔',
    'sermons.youtubeChannelCta': 'نگینہ سوشل ویلفیئر',
    'sermons.naginaTvEyebrow': 'نگینہ ٹی وی',
    'sermons.naginaTvTitle': 'نگینہ ٹی وی سے تازہ ترین',
    'sermons.naginaTvLead':
      'نگینہ ٹی وی (سیدھا راستہ بیانات کا چینل) کی تازہ ویڈیوز — خود بخود اپ ڈیٹ ہوتی ہیں۔',
    'sermons.latestLoading': 'تازہ ویڈیوز لوڈ ہو رہی ہیں…',
    'sermons.archiveHint':
      'پرانا بیان ڈھونڈ رہے ہیں؟ اوپر تلاش استعمال کریں — اس میں پورا سیدھا راستہ آرکائیو شامل ہے۔',
    'sermons.sourceNaginaTv': 'نگینہ ٹی وی',
    'sermons.sourceOrgYoutube': 'نگینہ سوشل ویلفیئر',
    'sermons.sourceArchive': 'سیدھا راستہ آرکائیو',
